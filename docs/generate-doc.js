  ...
  sections: [
    ...
    // ====== 5. INSTRUCCIONES DE RÉPLICA ======
    {
      ...
      children: [
        ...
        h2("5.5 Verificaci\u00F3n de conexi\u00F3n con el carrito"),
        p("Antes de enviar la primera instrucci\u00F3n desde el frontend, es necesario verificar que el micro-ros-agent est\u00E9 funcionando y que el ESP32 est\u00E9 suscrito correctamente al t\u00F3pico /cmd_vel. Ejecutar los siguientes pasos en PowerShell:"),
        codeBlock("docker ps"),
        p("Verificar que el contenedor micro-ros-agent est\u00E9 corriendo. Si no lo est\u00E1, iniciarlo:"),
        codeBlock("docker start pdyp_final_micro-ros-agent_1"),
        p("Ingresar al contenedor y publicar un comando de prueba:"),
        codeBlock("docker exec -it pdyp_final_micro-ros-agent_1 bash"),
        codeBlock("source /opt/ros/jazzy/setup.bash"),
        codeBlock('ros2 topic pub --once /cmd_vel geometry_msgs/msg/Twist "{linear: {x: 1.0}, angular: {z: 0.0}}"'),
        p("Si el carrito se mueve hacia adelante, la conexi\u00F3n est\u00E1 lista. Si no se mueve, presionar el bot\u00F3n EN (Enable) en el ESP32 para reiniciar el firmware, esperar a que termine la prueba de motores (~5 segundos) y volver a intentar la publicaci\u00F3n del t\u00F3pico."),

        h2("5.6 Verificaci\u00F3n del sistema completo"),
